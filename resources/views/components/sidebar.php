...
<div>
                        ...
                        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                            <li>
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        <a href="/marmiteux/my-account" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-pink-200 hover:bg-pink-700 hover:text-white">
                                    ...
                                    <li>
                                        ...
                                        <a href="/marmiteux/my-account/recipes" class="group flex gap-x-3 rounded-md bg-pink-700 p-2 text-sm font-semibold leading-6 text-white">
    ...
    <div class="sticky top-0 z-40 flex items-center gap-x-6 bg-pink-600 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
        <button type="button" class="-m-2.5 p-2.5 text-pink-200 lg:hidden">
